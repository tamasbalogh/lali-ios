...
class GameType5Controller: UIViewController {
    ...
    func setUp(){
        ...
        //Shuffle answers
        let shuffledAnswers = Utils.shuffleArray(array: sentences)
    ...
    @objc func informationButtonPressed() {
        let alert = UIAlertController(title: "Information", message: "gametype5".localizableString(lang: Utils.getLanguage()), preferredStyle: .alert)
